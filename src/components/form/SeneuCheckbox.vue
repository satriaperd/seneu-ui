...
.seneu-checkbox--sm   .seneu-checkbox__wrap { width: 16px; height: 16px; margin-top: 2px; }
.seneu-checkbox--base .seneu-checkbox__wrap { width: 20px; height: 20px; margin-top: 1px; }
.seneu-checkbox--lg   .seneu-checkbox__wrap { width: 24px; height: 24px; margin-top: 0;   }
